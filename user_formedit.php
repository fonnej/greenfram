    ...
    <div class="container" >
      ...
      <div class="col-md-4"></div>
        <div class="col-md-4"> <br>
          ...
          <center><img src="p_img/photo_all/pp1.png" width="30%" align='center'></center><br>
          <center><h4>แก้ไขข้อมูลสมาชิก</h4></center>
          
          <form action="user_formedit_db.php" method="post"> 
          <div class="input-group mb-3">
              <label for="name" class="col-sm-2 col-form-label"> Username:  </label>
              <div class="col-sm-10">
                <input type="text" name="user_id" class="form-control" required value="<?= $row['user_id'];?>" minlength="3">
              </div>
            </div>
            <div class="input-group mb-3">
              <label for="name" class="col-sm-2 col-form-label"> Password:  </label>
              <div class="col-sm-10">
                <input type="password" name="pass" class="form-control" required value="<?= $row['pass'];?>" minlength="3" >
              </div>
            </div>
            <div class="input-group mb-3">
              <label for="name" class="col-sm-2 col-form-label"> คำนำหน้า:  </label>
              <div class="col-sm-10">
                <input type="text" name="title" class="form-control" required value="<?= $row['title'];?>" minlength="3" >
              </div>
            </div>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" name="lname" class="form-control" required value="<?= $row['lname'];?>" minlength="3" >
              </div>
            </div>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" name="social_account" class="form-control" required value="<?= $row['social_account'];?>" minlength="3" >
              </div>
            </div>
            <div class="input-group mb-3">
          ...
          <center><a href="user_list.php" class="btn btn-secondary"><i class="bi bi-reply-all"></i> ย้อนกลับ</a> </center><br><br></center>
          <center><button type="submit" class="btn btn-success"><i class="bi bi-check2-circle"></i> บันทึกข้อมูล</button><br><br></center>
          </div>
          </form>
        </div>
      </div>
