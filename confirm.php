    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <a href="cart.php" class="btn btn-outline-warning"><i class="bi bi-arrow-return-left"></i> ย้อนกลับ</a></td>
                <a href="index.php" class="btn btn-outline-dark"><i class="bi bi-house"></i> หน้าหลัก</a></td>
                <form id="frmcart" name="frmcart" method="post" action="saveorder.php">
                    <table class="table table-striped table-hover">
                        <br>
                        <tr>
                            <th width="5%" bgcolor="ffff99">ลำดับที่</th>
                    ...
                    <center>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="inputEmail4">ชื่อ :<span style="color: red;">&nbsp;*</label>
                                <input type="text" class="form-control" id="inputEmail4" placeholder="ชื่อ-นามสกุล"
                                    name="fname" required /value="<?php echo $_SESSION['fname'] ?>">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="sel1">นามสกุล:<span style="color: red;">&nbsp;*</label>
                                <input type="text" class="form-control" id="inputCity" placeholder="กรุณาใส่ตำบล/แขวง"
                                    name="lname" required /value="<?php echo $_SESSION['lname'] ?>">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="inputCity">Email :<span style="color: red;">&nbsp;*</label>
                                    <input type="Email" class="form-control" id="inputCity" placeholder="Email"
                                        name="email" required /value="<?php echo $_SESSION['email'] ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputCity">เบอร์โทรศัพท์ :<span style="color: red;">&nbsp;*</label>
                                    <input type="text" class="form-control" id="inputCity" placeholder="เบอร์โทรศัพท์"
                                        name="phone" required /value="<?php echo $_SESSION['phone'] ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="sel1">รายละเอียดที่อยู่ในการจัดส่ง:<span style="color: red;">&nbsp;*</label>
                                    <input type="text" name="address" id="address" class="form-control"
                                        placeholder="328/30 ลาดพร้าวซอย 1 ถนน ลาดพร้าว"
            ...
            <br>
            <center><button type="submit" name="Submit2" value="สั่งซื้อ" class="btn btn-outline-success"><i class="bi bi-cart-check-fill"></i> สั่งซื้อสินค้า</button></center> 
            </form>
        </div>
    </div>
    <br>
